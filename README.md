...
The databases are based on and compatible with [Genestrip 2.7](https://github.com/pfeiferd/genestrip/releases/tag/v2.7).
...
to the [`projects` folder's](https://github.com/pfeiferd/genestrip-db/tree/master/data/projects) state of this project, after the script `bin/makedbs.sh` has run successfully based on the [RefSeq Release 234](https://ftp.ncbi.nlm.nih.gov/refseq/release/RELEASE_NUMBER).
